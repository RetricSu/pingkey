...
PingKey is our answer: a single, shareable link that lets anyone drop you a *one-off, signed* message—no email, no app, no server of yours to babysit.
...
PingKey sits on the [Nostr relay network](https://nostr.com/), so you don’t host or maintain anything. Spin up a key pair in seconds and you’re live.
...
* **Custom stamp themes**—choose stamp style you like inside the PoW mosaic

---

## Get Started

1. Visit **https://pingkey.xyz/signin**
2. Enter a password to protect your PingKey private key on local browser
3. View your profile page and edit your profile and relay list
4. Copy your PingKey link and paste it where the world can see.
