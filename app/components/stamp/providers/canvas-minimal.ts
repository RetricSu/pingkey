...
export class CanvasMinimalProvider implements HashArtProvider {
  ...
  private drawArt(ctx: CanvasRenderingContext2D, hashStr: string, zeros: number, width: number, height: number): void {
    // 清空画布
    ...
    // 根据难度级别绘制不同的图案
    if (zeros === 0) {
      this.drawDots(ctx, getHashValue, baseHue, saturation, lightness, width, height);
    } else if (zeros <= 2) {
      this.drawLines(ctx, getHashValue, baseHue, saturation, lightness, width, height);
    } else if (zeros <= 4) {
      this.drawRectangles(ctx, getHashValue, baseHue, saturation, lightness, width, height);
    } else if (zeros <= 6) {
      this.drawCircles(ctx, getHashValue, baseHue, saturation, lightness, width, height);
    } else {
      this.drawComplex(ctx, getHashValue, baseHue, saturation, lightness, width, height);
    }
  }

  private drawDots(ctx: CanvasRenderingContext2D, getHashValue: Function, baseHue: number, saturation: number, lightness: number, width: number, height: number): void {
  ...
  private drawLines(ctx: CanvasRenderingContext2D, getHashValue: Function, baseHue: number, saturation: number, lightness: number, width: number, height: number): void {
  ...
  private drawRectangles(ctx: CanvasRenderingContext2D, getHashValue: Function, baseHue: number, saturation: number, lightness: number, width: number, height: number): void {
  ...
  private drawCircles(ctx: CanvasRenderingContext2D, getHashValue: Function, baseHue: number, saturation: number, lightness: number, width: number, height: number): void {
  ...
  private drawComplex(ctx: CanvasRenderingContext2D, getHashValue: Function, baseHue: number, saturation: number, lightness: number, width: number, height: number): void {
    // 组合多种元素
    this.drawRectangles(ctx, getHashValue, baseHue, saturation, lightness, width, height);
    this.drawCircles(ctx, getHashValue, (baseHue + 120) % 360, saturation, lightness, width, height);
    this.drawLines(ctx, getHashValue, (baseHue + 240) % 360, saturation, lightness, width, height);
