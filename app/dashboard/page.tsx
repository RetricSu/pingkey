...
export const metadata = {
  title: "Dashboard",
  description: "Read your letters",
};

// Sample letters data - in a real app, this would come from a database or API
const sampleLetters = [
  {
    id: "1",
    from: "John Doe",
    subject: "Welcome to ReachMe",
    content: "Thank you for signing up for ReachMe. We're excited to have you on board and look forward to helping you connect with others in a meaningful way.",
  ...
  },
  {
    ...
    content: "It was wonderful meeting you at the conference last week. I'd love to continue our conversation about sustainable technology solutions. Your insights were truly valuable.",
  ...
  },
  {
    ...
    content: "We've just released some exciting new features to make your ReachMe experience even better. Check out the improved dashboard and new privacy controls.",
  ...
  },
  {
    ...
    content: "I came across your profile and was impressed by your work. I have a project that I think would benefit from your expertise. Would you be interested in discussing this further?",
    receivedAt: "2024-01-08",
    read: false,
  },
];

function LetterCard({ letter }: { letter: typeof sampleLetters[0] }) {
  return (
    <div className={`group relative bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-lg p-6 transition-all duration-200 hover:shadow-md hover:border-neutral-300 dark:hover:border-neutral-700 ${!letter.read ? 'ring-2 ring-blue-100 dark:ring-blue-900/20 bg-blue-50/30 dark:bg-blue-950/10' : ''}`}>
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-gradient-to-br from-neutral-200 to-neutral-300 dark:from-neutral-700 dark:to-neutral-800 rounded-full flex items-center justify-center text-sm font-medium text-neutral-600 dark:text-neutral-300">
              {letter.from.split(' ').map(n => n[0]).join('').slice(0, 2)}
            </div>
            <div>
      ...
      <div className="flex items-center justify-between">
        <div className="flex gap-2">
          <button className="px-3 py-1.5 text-sm bg-neutral-100 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300 rounded-md hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-colors">
            Reply
          </button>
          {!letter.read && (
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-neutral-600 dark:text-neutral-400">
            {totalCount === 0 ? 'No letters yet' : `${totalCount} total letters`}
            {unreadCount > 0 && (
